        ...
        <div className="flex items-center gap-4 shrink-0">
          ...
          <div className="hidden md:flex items-center gap-4">
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="relative overflow-hidden group flex items-center justify-center gap-2 h-10 px-5 rounded-full text-xs font-semibold uppercase tracking-wider text-white bg-[#0284c7] hover:shadow-[0_0_20px_rgba(2,132,199,0.4)] transition-all duration-300"
            >
        ...
        {mobileMenuOpen && (
          ...
          >
            ...
            <a
              ...
              className="flex items-center justify-center gap-2 w-full py-4 rounded-xl text-sm font-semibold uppercase tracking-wider text-white bg-[#0284c7]"
            >
              <span>Get Started</span>
