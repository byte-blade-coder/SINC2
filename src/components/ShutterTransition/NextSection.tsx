...
export function NextSection() {
  ...
  return (
    <div
      ref={ref}
      className="w-full min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center relative overflow-hidden pt-32 pb-20 md:pt-40 md:pb-24"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[45fr_55fr] gap-12 lg:gap-16 xl:gap-20 items-start">
          ...
          <div className="flex flex-col">
            ...
            <motion.div
              ...
              className="h-px w-12 bg-[#23abe6]/40 mb-8"
            />
